 ...
 *   Copyright (c) 2011 - GreyWyvern http://www.greywyvern.com/code/bsd.txt
 */
...
if ($params->get('vki_font')!='' ){ ?>
<style type="text/css">
@font-face {
	font-style: normal;
	font-family: 'keyboardCustom';
	src: url(<?php echo $params->get('vki_font'); ?>);
}

.<?php echo $params->get('apply_specific_classname'); ?>, #keyboardInputMaster * {
	font-family: 'keyboardCustom'!important;
}
</style>
<?php }
...
elseif ($params->get('default_keyboard')=='glag') {echo $params->get('keyboard_glag_name_original');}
...
elseif ($params->get('default_keyboard')=='chu') {echo $params->get('keyboard_chu_name_original');}
...
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_ar_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_ar_name_site'); ?>", 'keys': [
      ...
      [["<?php echo $params->get('vki_tab'); ?>", "<?php echo $params->get('vki_tab'); ?>"], ["\u0636", "\u064e"], ["\u0635", "\u064b"], ["\u062b", "\u064f"], ["\u0642", "\u064c"], ["\u0641", "\u0644"], ["\u063a", "\u0625"], ["\u0639", "\u2018"], ["\u0647", "\u00f7"], ["\u062e", "\u00d7"], ["\u062d", "\u061b"], ["\u062c", "<"], ["\u062f", ">"], ["\\", "|"]],
...
<?php } ?>
<?php if (($params->get('keyboard_glag', 1)) OR ($params->get('default_keyboard')=='glag'))
{ ?>
...
<?php } ?>
<?php if (($params->get('keyboard_ja', 1)) OR ($params->get('default_keyboard')=='ja'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_ja_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_ja_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_ka', 1)) OR ($params->get('default_keyboard')=='ka'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_ka_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_ka_name_site'); ?>", 'keys': [
      [["\u201E", "\u201C"], ["!", "1"], ["?", "2"], ["\u2116", "3"], ["\u00A7", "4"], ["%", "5"], [":", "6"], [".", "7"], [";", "8"], [",", "9"], ["/", "0"], ["\u2013", "-"], ["=", "+"], ["<?php echo $params->get('vki_bksp'); ?>", "<?php echo $params->get('vki_bksp'); ?>"]],
...
<?php } ?>
<?php if (($params->get('keyboard_kk', 1)) OR ($params->get('default_keyboard')=='kk'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_kk_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_kk_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_km', 1)) OR ($params->get('default_keyboard')=='km'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_km_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_km_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_kn', 1)) OR ($params->get('default_keyboard')=='kn'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_kn_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_kn_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_ko', 1)) OR ($params->get('default_keyboard')=='ko'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_ko_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_ko_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_ku', 1)) OR ($params->get('default_keyboard')=='ku'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_ku_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_ku_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_ky', 1)) OR ($params->get('default_keyboard')=='ky'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_ky_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_ky_name_site'); ?>", 'keys': [
      [["\u0451", "\u0401"], ["1", "!"], ["2", '"'], ["3", "\u2116"], ["4", ";"], ["5", "%"], ["6", ":"], ["7", "?"], ["8", "*"], ["9", "("], ["0", ")"], ["-", "_"], ["=", "+"], ["<?php echo $params->get('vki_bksp'); ?>", "<?php echo $params->get('vki_bksp'); ?>"]],
...
<?php } ?>
<?php if (($params->get('keyboard_lv', 1)) OR ($params->get('default_keyboard')=='lv'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_lv_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_lv_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_lt', 1)) OR ($params->get('default_keyboard')=='lt'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_lt_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_lt_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_hu', 1)) OR ($params->get('default_keyboard')=='hu'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_hu_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_hu_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_mt', 1)) OR ($params->get('default_keyboard')=='mt'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_mt_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_mt_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_mk', 1)) OR ($params->get('default_keyboard')=='mk'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_mk_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_mk_name_site'); ?>", 'keys': [
      [["`", "~"], ["1", "!"], ["2", "\u201E"], ["3", "\u201C"], ["4", "\u2019"], ["5", "%"], ["6", "\u2018"], ["7", "&"], ["8", "*"], ["9", "("], ["0", ")"], ["-", "_"], ["=", "+"], ["<?php echo $params->get('vki_bksp'); ?>", "<?php echo $params->get('vki_bksp'); ?>"]],
...
<?php } ?>
<?php if (($params->get('keyboard_ml', 1)) OR ($params->get('default_keyboard')=='ml'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_ml_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_ml_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_misc', 1)) OR ($params->get('default_keyboard')=='misc'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_misc_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_misc_name_site'); ?>", 'keys': [
      [["\u2605", "\u2606", "\u260e", "\u260f"], ["\u2648", "\u2673", "\u2659", "\u2630"], ["\u2649", "\u2674", "\u2658", "\u2631"], ["\u264a", "\u2675", "\u2657", "\u2632"], ["\u264b", "\u2676", "\u2656", "\u2633"], ["\u264c", "\u2677", "\u2655", "\u2634"], ["\u264d", "\u2678", "\u2654", "\u2635"], ["\u264e", "\u2679", "\u265f", "\u2636"], ["\u264f", "\u267a", "\u265e", "\u2637"], ["\u2650", "\u267b", "\u265d", "\u2686"], ["\u2651", "\u267c", "\u265c", "\u2687"], ["\u2652", "\u267d", "\u265b", "\u2688"], ["\u2653", "\u2672", "\u265a", "\u2689"], ["<?php echo $params->get('vki_bksp'); ?>", "<?php echo $params->get('vki_bksp'); ?>"]],
      [["\u263f", "\u2680", "\u268a", "\u26a2"], ["\u2640", "\u2681", "\u268b", "\u26a3"], ["\u2641", "\u2682", "\u268c", "\u26a4"], ["\u2642", "\u2683", "\u268d", "\u26a5"], ["\u2643", "\u2684", "\u268e", "\u26a6"], ["\u2644", "\u2685", "\u268f", "\u26a7"], ["\u2645", "\u2620", "\u26ff", "\u26a8"], ["\u2646", "\u2622", "\u2692", "\u26a9"], ["\u2647", "\u2623", "\u2693", "\u26b2"], ["\u2669", "\u266d", "\u2694", "\u26ac"], ["\u266a", "\u266e", "\u2695", "\u26ad"], ["\u266b", "\u266f", "\u2696", "\u26ae"], ["\u266c", "\u2607", "\u2697", "\u26af"], ["\u26f9", "\u2608", "\u2698", "\u26b0"], ["\u267f", "\u262e", "\u2638", "\u2609"]],
      [["<?php echo $params->get('vki_tab'); ?>", "<?php echo $params->get('vki_tab'); ?>"], ["\u261e", "\u261c", "\u261d", "\u261f"], ["\u261b", "\u261a", "\u2618", "\u2619"], ["\u2602", "\u2614", "\u26f1", "\u26d9"], ["\u2615", "\u2668", "\u26fe", "\u26d8"], ["\u263a", "\u2639", "\u263b", "\u26dc"], ["\u2617", "\u2616", "\u26ca", "\u26c9"], ["\u2660", "\u2663", "\u2665", "\u2666"], ["\u2664", "\u2667", "\u2661", "\u2662"], ["\u26c2", "\u26c0", "\u26c3", "\u26c1"], ["\u2624", "\u2625", "\u269a", "\u26b1"], ["\u2610", "\u2611", "\u2612", "\u2613"], ["\u2628", "\u2626", "\u2627", "\u2629"], ["\u262a", "\u262b", "\u262c", "\u262d"], ["\u26fa", "\u26fb", "\u26fc", "\u26fd"]],
      [["<?php echo $params->get('vki_caps'); ?>", "<?php echo $params->get('vki_caps'); ?>"], ["\u262f", "\u2670", "\u2671", "\u267e"], ["\u263c", "\u2699", "\u263d", "\u263e"], ["\u26c4", "\u2603", "\u26c7", "\u26c6"], ["\u26a0", "\u26a1", "\u2621", "\u26d4"], ["\u26e4", "\u26e5", "\u26e6", "\u26e7"], ["\u260a", "\u260b", "\u260c", "\u260d"], ["\u269c", "\u269b", "\u269d", "\u2604"], ["\u26b3", "\u26b4", "\u26b5", "\u26b6"], ["\u26b7", "\u26bf", "\u26b8", "\u26f8"], ["\u26b9", "\u26ba", "\u26bb", "\u26bc"], ["\u26bd", "\u26be", "\u269f", "\u269e"], ["<?php echo $params->get('vki_enter'); ?>", "<?php echo $params->get('vki_enter'); ?>"]],
...
<?php } ?>
<?php if (($params->get('keyboard_mn', 1)) OR ($params->get('default_keyboard')=='mn'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_mn_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_mn_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_mr', 1)) OR ($params->get('default_keyboard')=='mr'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_mr_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_mr_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_my', 1)) OR ($params->get('default_keyboard')=='my'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_my_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_my_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_nl', 1)) OR ($params->get('default_keyboard')=='nl'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_nl_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_nl_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_no', 1)) OR ($params->get('default_keyboard')=='no'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_no_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_no_name_site'); ?>", 'keys': [
      [["|", "\u00a7"], ["1", "!"], ["2", '"', "@"], ["3", "#", "\u00a3"], ["4", "\u00a4", "$"], ["5", "%"], ["6", "&"], ["7", "/", "{"], ["8", "(", "["], ["9", ")", "]"], ["0", "=", "}"], ["+", "?"], ["\\", "`", "\u00b4"], ["<?php echo $params->get('vki_bksp'); ?>", "<?php echo $params->get('vki_bksp'); ?>"]],
      [["<?php echo $params->get('vki_tab'); ?>", "<?php echo $params->get('vki_tab'); ?>"], ["q", "Q"], ["w", "W"], ["e", "E", "\u20ac"], ["r", "R"], ["t", "T"], ["y", "Y"], ["u", "U"], ["i", "I"], ["o", "O"], ["p", "P"], ["\u00e5", "\u00c5"], ["\u00a8", "^", "~"], ["'", "*"]],
...
<?php } ?>
<?php if (($params->get('keyboard_ps', 1)) OR ($params->get('default_keyboard')=='ps'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_ps_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_ps_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_pa', 1)) OR ($params->get('default_keyboard')=='pa'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_pa_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_pa_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_pl1', 1)) OR ($params->get('default_keyboard')=='pl1'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_pl1_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_pl1_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_pl2', 1)) OR ($params->get('default_keyboard')=='pl2'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_pl2_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_pl2_name_site'); ?>", 'keys': [
      [["`", "~"], ["1", "!"], ["2", "@"], ["3", "#"], ["4", "$"], ["5", "%"], ["6", "^"], ["7", "&"], ["8", "*"], ["9", "("], ["0", ")"], ["-", "_"], ["=", "+"], ["<?php echo $params->get('vki_bksp'); ?>", "<?php echo $params->get('vki_bksp'); ?>"]],
...
<?php } ?>
<?php if (($params->get('keyboard_pt-BR', 1)) OR ($params->get('default_keyboard')=='pt-BR'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_pt-BR_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_pt-BR_name_site'); ?>", 'keys': [
      [["'", '"'], ["1", "!", "\u00b9"], ["2", "@", "\u00b2"], ["3", "#", "\u00b3"], ["4", "$", "\u00a3"], ["5", "%", "\u00a2"], ["6", "\u00a8", "\u00ac"], ["7", "&"], ["8", "*"], ["9", "("], ["0", ")"], ["-", "_"], ["=", "+", "\u00a7"], ["<?php echo $params->get('vki_bksp'); ?>", "<?php echo $params->get('vki_bksp'); ?>"]],
...
<?php } ?>
<?php if (($params->get('keyboard_pt', 1)) OR ($params->get('default_keyboard')=='pt'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_pt_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_pt_name_site'); ?>", 'keys': [
      [["\\", "|"], ["1", "!"], ["2", '"', "@"], ["3", "#", "\u00a3"], ["4", "$", "\u00a7"], ["5", "%"], ["6", "&"], ["7", "/", "{"], ["8", "(", "["], ["9", ")", "]"], ["0", "=", "}"], ["'", "?"], ["\u00ab", "\u00bb"], ["<?php echo $params->get('vki_bksp'); ?>", "<?php echo $params->get('vki_bksp'); ?>"]],
      [["<?php echo $params->get('vki_tab'); ?>", "<?php echo $params->get('vki_tab'); ?>"], ["q", "Q"], ["w", "W"], ["e", "E", "\u20ac"], ["r", "R"], ["t", "T"], ["y", "Y"], ["u", "U"], ["i", "I"], ["o", "O"], ["p", "P"], ["+", "*", "\u00a8"], ["\u00b4", "`"], ["~", "^"]],
...
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_ro_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_ro_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_ru', 1)) OR ($params->get('default_keyboard')=='ru'))
{ ?>
...
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_de-CH_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_de-CH_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_sq', 1)) OR ($params->get('default_keyboard')=='sq'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_sq_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_sq_name_site'); ?>", 'keys': [
      [["\\", "|"], ["1", "!", "~"], ["2", '"', "\u02C7"], ["3", "#", "^"], ["4", "$", "\u02D8"], ["5", "%", "\u00B0"], ["6", "^", "\u02DB"], ["7", "&", "`"], ["8", "*", "\u02D9"], ["9", "(", "\u00B4"], ["0", ")", "\u02DD"], ["-", "_", "\u00A8"], ["=", "+", "\u00B8"], ["<?php echo $params->get('vki_bksp'); ?>", "<?php echo $params->get('vki_bksp'); ?>"]],
...
<?php } ?>
<?php if (($params->get('keyboard_sk', 1)) OR ($params->get('default_keyboard')=='sk'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_sk_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_sk_name_site'); ?>", 'keys': [
...
<?php } ?>
 <?php if (($params->get('keyboard_chu', 1)) OR ($params->get('default_keyboard')=='chu'))
{ ?>   
  this.VKI_layout['<?php echo $params->get('keyboard_chu_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_chu_name_site'); ?>", 'keys': [
      [["\u{481}", "\u{480}", "\u{A67D}", "\u{A67F}"], ["\u{A67C}", "\u{482}", "\u{A67C}", "\u{482}"], ["\u{A66F}", "\u{488}", "\u{A66F}", "\u{488}"], ["\u{483}", "\u{489}", "\u{483}", "\u{489}"], ["\u{485}", "\u{A670}", "\u{485}", "\u{A670}"], ["\u{486}", "\u{A671}", "\u{486}", "\u{A671}"], ["\u{487}", "\u{A672}", "\u{487}", "\u{A672}"], [ "\u{484}", "\u{203B}", "\u{484}", "\u{203B}"], ["\u{306}", "\u{A673}", "\u{306}", "\u{A673}"], ["\u{2D8}", "\u{A67E}", "\u{2D8}", "\u{A67E}"], ["\u{B4}", "`", "\u{B4}", "`"], ["\u{10FB}", "\u{2056}", "\u{10FB}", "\u{2056}"], ["\u{308}", "\u{2058}", "\u{308}", "\u{2058}"],  ["\u{446}", "\u{426}", "\u{45F}", "\u{40F}"], ["\u{44D}", "\u{42D}"], ["<?php echo $params->get('vki_bksp'); ?>", "<?php echo $params->get('vki_bksp'); ?>"]],
      [["<?php echo $params->get('vki_tab'); ?>", "<?php echo $params->get('vki_tab'); ?>"], ["\u{439}", "\u{419}", "\u{457}", "\u{407}"], ["\u{456}", "\u{406}", "\u{A65F}", "\u{A65E}"], ["\u{443}", "\u{423}", "\u{479}", "\u{478}"], ["\u{43A}", "\u{41A}", "\u{46F}", "\u{46E}"], ["\u{435}", "\u{415}", "\u{465}", "\u{464}"], ["\u{43D}", "\u{41D}", "\u{469}", "\u{468}"], ["\u{433}", "\u{413}", "\u{467}", "\u{466}"], ["\u{448}", "\u{428}"], ["\u{449}", "\u{429}", "\u{455}", "\u{405}"], ["\u{437}", "\u{417}", "\u{A641}", "\u{A640}"], ["\u{445}", "\u{425}", "\u{A643}", "\u{A642}"], ["\u{2059}", "\u{387}", "\u{2059}", "\u{387}"],  [".", ",", ".", ","], ["\u{33E}", "\u{2E2F}", "\u{33E}", "\u{2E2F}"]],
      [["<?php echo $params->get('vki_caps'); ?>", "<?php echo $params->get('vki_caps'); ?>"], ["\u{444}", "\u{424}", "\u{473}", "\u{472}"], ["\u{44B}", "\u{42B}", "\u{477}", "\u{476}"], ["\u{432}", "\u{412}", "\u{475}", "\u{474}"], ["\u{44A}", "\u{42A}", "\u{A64B}", "\u{A64A}"], ["\u{430}", "\u{410}", "\u{454}", "\u{404}"], ["\u{43F}", "\u{41F}", "\u{471}", "\u{470}"], ["\u{440}", "\u{420}"], ["\u{43E}", "\u{41E}", "\u{461}", "\u{460}"], ["\u{43B}", "\u{41B}", "\u{47B}", "\u{47A}"], ["\u{434}", "\u{414}", "\u{A649}", "\u{A648}"], ["\u{436}", "\u{416}", "\u{452}", "\u{402}"], ["<?php echo $params->get('vki_enter'); ?>", "<?php echo $params->get('vki_enter'); ?>"]],
      [["<?php echo $params->get('vki_shift'); ?>", "<?php echo $params->get('vki_shift'); ?>"], ["\u{44F}", "\u{42F}", "\u{A657}", "\u{A656}"], ["\u{447}", "\u{427}", "\u{45B}", "\u{40B}"], ["\u{463}", "\u{462}", "\u{A653}", "\u{A652}"], ["\u{441}", "\u{421}", "\u{46D}", "\u{46C}"], ["\u{43C}", "\u{41C}", "\u{46B}", "\u{46A}"], ["\u{438}", "\u{418}", "\u{2191}", "\u{2191}"], ["\u{442}", "\u{422}", "\u{47F}", "\u{47E}"], ["\u{44C}", "\u{42C}", "\u{47D}", "\u{47C}"], ["\u{431}", "\u{411}"], ["\u{44E}", "\u{42E}"], ["<?php echo $params->get('vki_shift'); ?>", "<?php echo $params->get('vki_shift'); ?>"]],
      [[" ", " ", " ", " "], ["<?php echo $params->get('vki_altgr'); ?>", "<?php echo $params->get('vki_altgr'); ?>"]]
    ], 'lang': ["chu"] };
<?php } ?>
<?php if (($params->get('keyboard_sh', 1)) OR ($params->get('default_keyboard')=='sh'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_sh_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_sh_name_site'); ?>", 'keys': [
      [["\u00B8", "\u00A8"], ["1", "!", "~"], ["2", '"', "\u02C7"], ["3", "#", "^"], ["4", "$", "\u02D8"], ["5", "%", "\u00B0"], ["6", "&", "\u02DB"], ["7", "/", "`"], ["8", "(", "\u02D9"], ["9", ")", "\u00B4"], ["0", "=", "\u02DD"], ["'", "?", "\u00A8"], ["+", "*", "\u00B8"], ["<?php echo $params->get('vki_bksp'); ?>", "<?php echo $params->get('vki_bksp'); ?>"]],
...
<?php } ?>
<?php if (($params->get('keyboard_sr', 1)) OR ($params->get('default_keyboard')=='sr'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_sr_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_sr_name_site'); ?>", 'keys': [
      [["`", "~"], ["1", "!"], ["2", '"'], ["3", "#"], ["4", "$"], ["5", "%"], ["6", "&"], ["7", "/"], ["8", "("], ["9", ")"], ["0", "="], ["'", "?"], ["+", "*"], ["<?php echo $params->get('vki_bksp'); ?>", "<?php echo $params->get('vki_bksp'); ?>"]],
...
<?php } ?>
<?php if (($params->get('keyboard_fi', 1)) OR ($params->get('default_keyboard')=='fi'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_fi_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_fi_name_site'); ?>", 'keys': [
      [["\u00a7", "\u00BD"], ["1", "!"], ["2", '"', "@"], ["3", "#", "\u00A3"], ["4", "\u00A4", "$"], ["5", "%", "\u20AC"], ["6", "&"], ["7", "/", "{"], ["8", "(", "["], ["9", ")", "]"], ["0", "=", "}"], ["+", "?", "\\"], ["\u00B4", "`"], ["<?php echo $params->get('vki_bksp'); ?>", "<?php echo $params->get('vki_bksp'); ?>"]],
...
<?php } ?>
<?php if (($params->get('keyboard_sv', 1)) OR ($params->get('default_keyboard')=='sv'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_sv_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_sv_name_site'); ?>", 'keys': [
      [["\u00a7", "\u00bd"], ["1", "!"], ["2", '"', "@"], ["3", "#", "\u00a3"], ["4", "\u00a4", "$"], ["5", "%", "\u20ac"], ["6", "&"], ["7", "/", "{"], ["8", "(", "["], ["9", ")", "]"], ["0", "=", "}"], ["+", "?", "\\"], ["\u00b4", "`"], ["<?php echo $params->get('vki_bksp'); ?>", "<?php echo $params->get('vki_bksp'); ?>"]],
      [["<?php echo $params->get('vki_tab'); ?>", "<?php echo $params->get('vki_tab'); ?>"], ["q", "Q"], ["w", "W"], ["e", "E", "\u20ac"], ["r", "R"], ["t", "T"], ["y", "Y"], ["u", "U"], ["i", "I"], ["o", "O"], ["p", "P"], ["\u00e5", "\u00c5"], ["\u00a8", "^", "~"], ["'", "*"]],
      [["<?php echo $params->get('vki_caps'); ?>", "<?php echo $params->get('vki_caps'); ?>"], ["a", "A"], ["s", "S"], ["d", "D"], ["f", "F"], ["g", "G"], ["h", "H"], ["j", "J"], ["k", "K"], ["l", "L"], ["\u00f6", "\u00d6"], ["\u00e4", "\u00c4"], ["<?php echo $params->get('vki_enter'); ?>", "<?php echo $params->get('vki_enter'); ?>"]],
      [["<?php echo $params->get('vki_shift'); ?>", "<?php echo $params->get('vki_shift'); ?>"], ["<", ">", "|"], ["z", "Z"], ["x", "X"], ["c", "C"], ["v", "V"], ["b", "B"], ["n", "N"], ["m", "M", "\u03bc", "\u039c"], [",", ";"], [".", ":"], ["-", "_"], ["<?php echo $params->get('vki_shift'); ?>", "<?php echo $params->get('vki_shift'); ?>"]],
...
<?php } ?>
<?php if (($params->get('keyboard_fr-CH', 1)) OR ($params->get('default_keyboard')=='fr-CH'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_fr-CH_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_fr-CH_name_site'); ?>", 'keys': [
      [["\u00A7", "\u00B0"], ["1", "+", "\u00A6"], ["2", '"', "@"], ["3", "*", "#"], ["4", "\u00E7", "\u00B0"], ["5", "%", "\u00A7"], ["6", "&", "\u00AC"], ["7", "/", "|"], ["8", "(", "\u00A2"], ["9", ")"], ["0", "="], ["'", "?", "\u00B4"], ["^", "`", "~"], ["<?php echo $params->get('vki_bksp'); ?>", "<?php echo $params->get('vki_bksp'); ?>"]],
...
<?php } ?>
<?php if (($params->get('keyboard_syc', 1)) OR ($params->get('default_keyboard')=='syc'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_syc_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_syc_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_ta', 1)) OR ($params->get('default_keyboard')=='ta'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_ta_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_ta_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_te', 1)) OR ($params->get('default_keyboard')=='te'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_te_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_te_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_vi', 1)) OR ($params->get('default_keyboard')=='vi'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_vi_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_vi_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_th1', 1)) OR ($params->get('default_keyboard')=='th1'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_th1_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_th1_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_th2', 1)) OR ($params->get('default_keyboard')=='th2'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_th2_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_th2_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_tt', 1)) OR ($params->get('default_keyboard')=='tt'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_tt_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_tt_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_trf', 1)) OR ($params->get('default_keyboard')=='trf'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_trf_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_trf_name_site'); ?>", 'keys': [
      [['+', "*", "\u00ac"], ["1", "!", "\u00b9", "\u00a1"], ["2", '"', "\u00b2"], ["3", "^", "#", "\u00b3"], ["4", "$", "\u00bc", "\u00a4"], ["5", "%", "\u00bd"], ["6", "&", "\u00be"], ["7", "'", "{"], ["8", "(", '['], ["9", ")", ']'], ["0", "=", "}"], ["/", "?", "\\", "\u00bf"], ["-", "_", "|"], ["<?php echo $params->get('vki_bksp'); ?>", "<?php echo $params->get('vki_bksp'); ?>"]],
...
<?php } ?>
<?php if (($params->get('keyboard_trq', 1)) OR ($params->get('default_keyboard')=='trq'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_trq_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_trq_name_site'); ?>", 'keys': [
...
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_ur1_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_ur1_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_ur2', 1)) OR ($params->get('default_keyboard')=='ur2'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_ur2_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_ur2_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_uz', 1)) OR ($params->get('default_keyboard')=='uz'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_uz_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_uz_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_yi1', 1)) OR ($params->get('default_keyboard')=='yi1'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_yi1_name_original'); ?>'] = { // from http://www.yv.org/uyip/hebyidkbd.txt http://uyip.org/keyboards.html
    'name': "<?php echo $params->get('keyboard_yi1_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_yi2', 1)) OR ($params->get('default_keyboard')=='yi2'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_yi2_name_original'); ?>'] = { // from http://jidysz.net/ 
    'name': "<?php echo $params->get('keyboard_yi2_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_zh-Bopo', 1)) OR ($params->get('default_keyboard')=='zh-Bopo'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_zh-Bopo_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_zh-Bopo_name_site'); ?>", 'keys': [
...
<?php } ?>
<?php if (($params->get('keyboard_zh', 1)) OR ($params->get('default_keyboard')=='zh'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_zh_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_zh_name_site'); ?>", 'keys': [
      [["\u20AC", "~"], ["1", "!"], ["2", "@"], ["3", "#"], ["4", "$"], ["5", "%"], ["6", "^"], ["7", "&"], ["8", "*"], ["9", ")"], ["0", "("], ["-", "_"], ["=", "+"], ["<?php echo $params->get('vki_bksp'); ?>", "<?php echo $params->get('vki_bksp'); ?>"]],
...
<?php } ?>
<?php if (($params->get('keyboard_zh-Latn', 1)) OR ($params->get('default_keyboard')=='zh-Latn'))
{ ?>
  this.VKI_layout['<?php echo $params->get('keyboard_zh-Latn_name_original'); ?>'] = {
    'name': "<?php echo $params->get('keyboard_zh-Latn_name_site'); ?>", 'keys': [
...
<?php } ?>
  ...
  /* ***** Custom Dead Keys **************************************** */
<?php if (($params->get('keyboard_custom', 1)) OR ($params->get('default_keyboard')=='custom'))
{echo $params->get('keyboard_custom_deadkeys');} ?>
